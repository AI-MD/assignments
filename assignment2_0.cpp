...
int main() {
	cv::Mat srcMat = cv::imread("./samples/sample2.jpg", cv::IMREAD_GRAYSCALE);
	cv::Mat opencvResult, ourResult;

	cv::threshold(srcMat, opencvResult, 125, 255, cv::THRESH_BINARY);
	IPCVL::IMG_PROC::thresh_binary(srcMat, ourResult, 125);
